...
@section('content')
    ...
    <div class="row page-titles">
        <div class="col-md-5 col-8 align-self-center">
            <h3 class="text-themecolor">Slider Management</h3>
            <ol class="breadcrumb">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="exampleModalLabel1">Add New Slider Image</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                </div>
                <form action="{{ route('slider.store') }}" method="post" id="addEditForm" class="floating-labels" enctype="multipart/form-data">
                    <div class="modal-body">
                        ...
                        <div class="custom-file mb-3">
                            ...
                            <p>Select image of dimension 870 * 555</p>
                        </div>
                        <div class="form-group m-b-40">
    ...
    <script>
        ...
        $(document).ready(function(e) {
            ...
            var table = $('#dataTable').DataTable( {
                ...
                "serverSide": true,
                "ajax": {
                    "url": "{{ route('datatables.slider.list') }}",
                    "type": "GET"
                },
                "columns": [
                    {data: "title", name: "title" },
                    {data: "image", name: "image", searchable: false, orderable: false, render: function (data) {
                            return `<img src="${BaseUrl}/slider/${data}" width="100" height="100"/>`;
                        } },
            ...
            $("body").on("click",".deleteRecord",function(e) {
                e.preventDefault();
                var id = $(this).attr('id');
                var url = '{{ route('slider.destroy', 'xxxx') }}';
